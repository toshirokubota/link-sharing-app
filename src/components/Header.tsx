    ...
    return (
        <header className="w-full h-20">
        {
            logged ? 
                <nav>
                    <Link to="/">
                        <img src={staticAsset('/images/logo-devlinks-small.svg')} alt='logo' />
                    </Link>                
                    <div>
                        <Link to="/edit">
                            <span>
                        ...
                        <Link to="/profile">
                            ...
                            <span className="hidden">Profile Details</span>
                        </Link>
                    </div>
                    <Link to="/preview" className='boxed'>
                        <span>
                        ...
                        <span className="hidden">Previews</span>
                    </Link>
                </nav>
                :   
                <Link to="/">
