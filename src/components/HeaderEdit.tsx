...
export default function HeaderEdit({logged}: {logged: boolean}) {
        ...
        <header className="w-full h-20">
        {
            logged ? 
                <nav>
                    ...
                    <div>
                        <Link to="/edit" className={`${location.pathname==="/edit" ? "current": ""}`}>
                            <span>
                        ...
                        <Link to="/profile" className={'inline ' + `${location.pathname==="/profile" ? "current": ""}`}>
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" fill="none" viewBox="0 0 21 20">
                    ...
                    <Link to="/preview" className={'rect' + `${location.pathname==="/" ? " current": ""}`}>
